...
<section id="login-user" class="min-h-screen w-screen flex items-stretch text-white -ml-8">
    ...
    <div class="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0" style="background-color: #161616;">
        ...
        <div class="w-full py-6 z-20">
            <h1 class="my-6 font-mono text-white self-center text-2xl font-semibold whitespace-nowrap dark:text-white">
               <a href="/" class="flex justify-center items-center">
                  <img src="<?=$logo?>" class="w-14 h-auto mr-3" alt="Flowbite Logo">
                  <span><?=$title?></span>
              </a>
          </h1>
        ...
        <form class="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
            ...
            <div class="px-4 pb-2 pt-4">
                <button class="signin uppercase block w-full p-4 text-lg rounded-full bg-indigo-500 hover:bg-indigo-600 focus:outline-none">
                    <div id="loading-login" class="hidden">
                    ...
                    <span class="login-textBtn">Sign in</span>
                </button>
            </div>
